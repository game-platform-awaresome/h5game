...
public class HtmlActivity extends Activity {
	...
	private void sdkProxyinit(){
		...
		Data.getInstance().setApplicationContex(HtmlActivity.this);
	...
	private void WebViewListener(){
		...
		mweview.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url,
				...
				LoadingDialog.show(HtmlActivity.this, "拼命加载游戏中....", false);
				//与js协议接口
	...
	public class InitGame {
		...
		public void login() {
			...
			if(!isInit){
				...
				m_proxy.login(HtmlActivity.this);
			}
		...
		public void pay(String payContent) {
			try {
				...
				m_proxy.pay(HtmlActivity.this, payInfo);
